                ...
                <tbody>
                    @foreach ($employees as $employee)
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="{{ route('employees.show', ['employee' => $employee->employee->id]) }}" class="btn btn-outline-dark btn-sm me-2"><i class="bi-person-lines-fill"></i></a>
                                    <a href="{{ route('employees.edit', ['employee' => $employee->employee->id]) }}" class="btn btn-outline-dark btn-sm me-2"><i class="bi-pencil-square"></i></a>
